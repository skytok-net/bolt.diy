        ...
        <div className="flex-1 flex flex-col h-full w-full overflow-hidden">
          <div className="p-4 space-y-3">
            <div className="flex gap-2">
              <a
                href="/"
                className="flex-1 flex gap-2 items-center bg-prometheus-yellow/20 dark:bg-prometheus-navy/80 text-prometheus-navy dark:text-prometheus-yellow hover:bg-prometheus-yellow/30 dark:hover:bg-prometheus-navy/90 rounded-lg px-4 py-2 transition-colors"
              >
              ...
              <button
                ...
                className={classNames(
                  ...
                  selectionMode
                    ? 'bg-prometheus-navy dark:bg-prometheus-yellow text-white dark:text-prometheus-navy border border-prometheus-navy dark:border-prometheus-yellow'
            ...
            <div className="relative w-full">
              ...
              <input
                className="w-full bg-gray-50 dark:bg-gray-900 relative pl-9 pr-3 py-2 rounded-lg focus:outline-none focus:ring-1 focus:ring-prometheus-yellow/50 text-sm text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-500 border border-gray-200 dark:border-gray-800"
                type="search"
